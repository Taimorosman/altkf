...
export const seoData: Record<string, { ar: SEOData; en: SEOData }> = {
  home: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "مؤسسة أعمال التكييف", "مقاول تكييف مركزي الرياض", "توريد وتركيب تكييف VRF", "شركة تكييف تجاري الرياض", "تمديد دكت التكييف المركزي", "مشاريع تكييف صناعي السعودية", "أنظمة HVAC للمباني"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Commercial HVAC Riyadh", "VRF installation Saudi Arabia", "Central AC contractor Riyadh", "Industrial Chiller installation", "AC duct fabrication", "HVAC engineering contracts"]
    }
  },
  about: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "من نحن أعمال التكييف", "شركة تكييف تجاري الرياض", "مقاول HVAC معتمد", "تاريخ مؤسسة أعمال التكييف"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "About Al-Takeef HVAC", "Riyadh HVAC contractor", "mechanical engineering partner", "corporate cooling solutions"]
    }
  },
  contact: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "تواصل مع أعمال التكييف", "رقم شركة تكييف مركزي الرياض", "مبيعات التكييف المركزي", "تقديم مخططات تكييف"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Contact HVAC estimator", "Riyadh AC project number", "HVAC quotation Riyadh", "submit AC drawings"]
    }
  },
  projects: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "مشاريع التكييف المركزي", "سابقة أعمال HVAC", "مشاريع تكييف تجاري", "تكييف أبراج ومستشفيات"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "HVAC projects Riyadh", "commercial cooling references", "chiller installation portfolio", "VRF projects Saudi Arabia"]
    }
  },
  blog: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "مدونة التكييف الهندسي", "تصميم مجاري الهواء", "مقارنة VRF والشيلر", "حساب الأحمال الحرارية للمشاريع"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "HVAC engineering blog", "Riyadh duct design standards", "VRF vs chiller HVAC", "cooling load calculations"]
    }
  },
  vrf: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "تركيب تكييف VRF الرياض", "أنظمة تدفق التكييف المتغير", "مقاول تكييف VRF معتمد", "تكييف VRV الرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "VRF installation Riyadh", "commercial VRV installation", "multi-split VRF contracting", "VRV system Riyadh"]
    }
  },
  central: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "شركة تكييف مركزي بالرياض", "تركيب دكت تكييف مركزي", "مقاول HVAC تجاري بالرياض", "تمديد دكت تكييف الرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Central AC Riyadh", "commercial AC ductwork Riyadh", "HVAC contractor Saudi", "AC duct design Riyadh"]
    }
  },
  'concealed-duct': {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "تكييف مخفي كونسيلد الرياض", "مكيفات مخفي دكت بالرياض", "تركيب تكييف دكت سبليت", "تصميم مجاري الهواء بالرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Concealed duct split AC", "Concealed AC Riyadh", "Duct split installation Riyadh", "commercial hidden AC"]
    }
  },
  chiller: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "تكييف شيلر الرياض", "تركيب مبردات مياه صناعية بالرياض", "صيانة تشيلرات مصانع الرياض", "تبريد مياه تشيلر الرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Chiller AC Riyadh", "industrial water chiller installation Riyadh", "cooling tower installation Riyadh", "chiller maintenance Riyadh"]
    }
  },
  crac: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "تبريد مراكز البيانات بالرياض", "تبريد CRAC الرياض", "تكييف غرف السيرفرات بالرياض", "Precision cooling Riyadh"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "CRAC units Riyadh", "Data center cooling Riyadh", "Precision cooling Saudi", "server room AC installation Riyadh"]
    }
  },
  'split-wall': {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "تركيب مكيف سبليت بالرياض", "مكيفات سبليت مشاريع الرياض", "توريد مكيفات سبليت بالجملة", "مشاريع تكييف سبليت بالرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Split AC Riyadh", "Split AC installation Riyadh", "bulk split AC supply Riyadh", "project split AC contracting"]
    }
  },
  cassette: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "مكيف كاسيت سقفي بالرياض", "مكيف كاسيت تجاري بالرياض", "تكييف معارض ومكاتب الرياض", "تركيب تكييف كاسيت بالرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Cassette AC Riyadh", "Cassette installation Riyadh", "Ceiling cassette Riyadh", "commercial cassette AC Riyadh"]
    }
  },
  maintenance: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "عقود صيانة تكييف سنوية بالرياض", "صيانة تكييف مركزي الرياض", "صيانة تشيلرات بالرياض", "صيانة HVAC للشركات بالرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "AC maintenance Riyadh", "commercial HVAC AMC Riyadh", "chiller maintenance contracts Riyadh", "industrial AC service Riyadh"]
    }
  },
  ventilation: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "أنظمة تهوية ميكانيكية بالرياض", "تهوية مستودعات بالرياض", "سحب دخان مواقف السيارات الرياض", "مراوح شفط تجارية بالرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "Mechanical ventilation Riyadh", "warehouse ventilation Riyadh", "smoke control systems Riyadh", "kitchen hood exhaust Riyadh"]
    }
  },
  store: {
    ar: {
      ...
      keywords: ["أعمال التكييف", "التكييف", "توريد أجهزة تكييف الرياض", "أسعار مكيفات مشاريع الرياض", "مبيعات معدات HVAC بالرياض", "موزع مكيفات معتمد بالرياض"]
    },
    en: {
      ...
      keywords: ["Al-Takeef", "Al-Takeef HVAC", "HVAC equipment supply Riyadh", "commercial AC unit prices Riyadh", "bulk AC sales Saudi", "approved HVAC supplier Riyadh"]
    }
  }
};
